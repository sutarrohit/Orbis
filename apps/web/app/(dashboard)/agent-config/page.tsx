    ...
    <main className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Fine-tune each agent&apos;s personality, voice, behavior rules, and
          knowledge base. Click an agent to expand its settings.
        </p>
      </div>
          ...
          return (
            ...
            >
              <Card className="overflow-hidden">
                <CollapsibleTrigger className="flex w-full items-center gap-4 p-4 text-left transition-colors hover:bg-muted/50">
                  <div
                    className={cn(
